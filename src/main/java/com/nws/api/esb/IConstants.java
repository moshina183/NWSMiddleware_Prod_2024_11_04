...
public class IConstants {
	...
	public static List<String> urlList = Arrays.asList("/api/v1/getmeterreading",
			...
			"/api/v1/getmmdata","api/v1/getintegrationdata","/api/v1/gettrafficinformaton", "/api/v2/getCompanyData");
	...
	public static List<String> urlListV2 = Arrays.asList("/api/v2/getmeterreading",
			...
			"api/v2/getmmdata","api/v2/getintegrationdata","/api/v2/gettrafficinformaton","api/v2/test", "/api/v2/getCompanyData");
